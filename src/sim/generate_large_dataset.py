...
param_path = "/mn/stornext/d16/cmbco/comap/nils/COMAP_general/src/sim/Parameterfiles_and_runlists/large_dataset/masked/sim2/"
...
l2gen_path = "/mn/stornext/d16/cmbco/comap/nils/comap/src/f90/l2gen/l2gen"
t0 = time.time()
...
for i in trange(len(param_files)):
    ...
    run_sim2tod = f"python {python_path} -p {param} -n 1000"
